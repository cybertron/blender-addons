...
class DialScale(bpy.types.Operator):
    ...
    font_size = FloatProperty(name="Font Size", description="Size of font used for text", default=1)
        ...
        while pos < end:
            ...
            for t in range(0,self.ticks):
                ...
                if self.dialType == "circular":
                    ...
                    bpy.ops.transform.rotate(value= angle + t*tick_step)
